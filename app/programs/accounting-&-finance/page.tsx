  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <CallToAction 
          title="Start Your Journey in Accounting & Finance"
          description="Join our Accounting & Finance program and gain the skills to become a financial leader in today's dynamic business world."
        />
      </main>
      <Footer />
    </div>
